<x-client-layout.clientapp>
  <div class="container bg-dark text-white book-container">
    ...
    <div class="row flex-wrap mt-3 mb-3">
        ...
        <a href="{{route('book.show',$book->id)}}" class="text-decoration-none text-white col-md-4 mt-3 mb-2 d-inline d-flex justify-content-center align-items-center">
          <div>

            <img src="{{ asset($book->image) }}" class="m-2" alt="{{ $book->title }}" width="200" height="300">
            <h5 class="card-title p-0">{{ mb_strimwidth($book->books_title, 0, 23, "...") }}</h5>
