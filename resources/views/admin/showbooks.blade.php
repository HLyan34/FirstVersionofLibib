  ...
  <x-slot name="slot">
    <div class="container mt-5 mb-5 border" style="background-color:#212529; ">
      <div class="card-header d-flex justify-content-between">
        ...
        <a href="{{route('books.index')}}" class="btn btn-warning d-flex justify-content-center align-items-center" style="height:50px;"> <i class="fa-solid fa-arrow-left"></i> <span class="ms-2">Back</span></a>
      </div>
      <div class="card-body">
        <div class='row'>
        ...
        <div class='row'>
          ...
          <div class="col-12 col-md-6 mt-3 mt-md-0">
            <a href="{{route('books.edit',$book->id)}}" class="edit btn btn-success btn-sm mt-2 me-3"><i class="fa-solid fa-pen"></i> <span class="ms-2">Edit</span></a>
            <a href="javascript:void(0);" onclick="document.getElementById('delete-form-{{ $book->id }}').submit();" class="btn btn-danger btn-sm mt-2"><i class="fa-solid fa-trash"></i><span class="ms-2">Delete</span></a>
