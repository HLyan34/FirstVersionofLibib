            ...
            <form action="{{route('books.update',$book->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group mt-3 me-sm-5  ps-2">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" value="{{$category->id}}" id="CheckBox{{$category->id}}" name="categories[]" {{in_array($category->id, $category_ids) ? 'checked' : ''}}>
...
{{$book->books_description}}
              ...
              <div class="form-group me-sm-5 mt-3 ps-2"> 
                <img src="{{asset($book->image)}}" alt="" style="width:250px;">
             </div> 
            ...
            @endphp
                <p class="me-3 text-white card-custom-body-text mt-3 mb-3">{{$filename}}</p>
              </div>
