  ...
  <x-slot name="slot">
    ...
    <div class="container mt-5 mb-5 border" style="background-color:#212529; ">
      <div class="card-header d-flex justify-content-between">
        ...
        <a href="{{route('books.trashed')}}" class="btn btn-warning d-flex justify-content-center align-items-center" style="height:50px;">Back</a>
      </div>
      <div class="card-body">
        <div class='row'>
        ...
        <div class='row'>
          ...
          <div class="col-12 col-md-6 mt-3 mt-md-0">
            ...
            <a href="javascript:void(0);" data-url="{{route('books.forceDelete', $book->id)}}" class="btn btn-danger btn-sm mt-2 delete-modal-btn me-3">Delete</a>
          </div>
        </div>
