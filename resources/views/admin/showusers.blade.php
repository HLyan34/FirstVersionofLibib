  ...
  <x-slot name="slot">
    <div class="container mt-5 mb-5 border" style="background-color:#212529; ">
      <div class="card-header d-flex justify-content-between">
        ...
        <a href="{{route('users.index')}}" class="btn btn-warning d-flex justify-content-center align-items-center" style="height:50px;">Back</a>
      </div>
      <div class="card-body">
        ...
        <div class='row'>
          ...
          <div class="col-12 col-md-6 mt-3 mt-md-0">
            <a href="{{route('users.edit',$user->id)}}" class="edit btn btn-success btn-sm mt-2 me-3">Edit</a>
            <a href="javascript:void(0);" onclick="document.getElementById('delete-form-{{ $user->id }}').submit();" class="btn btn-danger btn-sm mt-2">Delete</a>
