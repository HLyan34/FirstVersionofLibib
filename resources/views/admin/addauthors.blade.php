      ...
      <div class="container d-flex justify-content-center align-items-center mt-5 mb-5">
        <div class="card w-100" style="background-color: #1f2937; ">
          <div class="card-header d-flex justify-content-sm-between flex-column flex-sm-row justify-content-start align-items-sm-center align-items-start">
            ...
            <a class="btn btn-warning mt-2 me-5" href="{{route('authors.index')}}">View</a>
          </div>
          <div class="card-body">
            ...
            <form action="{{route('authors.store')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group me-sm-5 mt-2 ps-2">
                ...
                <input name='authorName' type="text" class="form-control" id="authorName" placeholder="Author Name">
              </div>
              ...
              <div class="form-group mt-3 me-sm-5  ps-2">
                ...
                <textarea name="authorDescription" id="authorDescription" class="form-control" cols="25" rows="8"></textarea>
              </div>
